---
name: "source-command-analyst"
description: "Migrated source command `analyst`"
---

# source-command-analyst

Use this skill when the user asks to run the migrated source command `analyst`.
...
- Hogwarts web app features (`/Users/abdout/hogwarts/AGENTS.md`)
