...
fun ChildTimetableScreen(
    ...
    val dayNames = listOf(
        stringResource(R.string.guardian_timetable_sun),
        stringResource(R.string.guardian_timetable_mon),
        stringResource(R.string.guardian_timetable_tue),
        stringResource(R.string.guardian_timetable_wed),
        stringResource(R.string.guardian_timetable_thu),
        stringResource(R.string.guardian_timetable_fri),
        stringResource(R.string.guardian_timetable_sat)
    )

    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(stringResource(R.string.guardian_timetable_title)) },
                navigationIcon = {
...
@Composable
private fun TimetableSlotRow(
    slot: ChildTimetableSlot,
    ...
    Card(
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                ...
                slot.roomNumber?.let {
                    Text(
                        text = stringResource(R.string.guardian_timetable_room, it),
                        style = MaterialTheme.typography.bodySmall,
                        color = MaterialTheme.colorScheme.onSurfaceVariant
                    )
                }
